...
<div class="card-header bg-secondary text-white">
	<h5 class="col-5 m-0 p-0 float-left"><i class="fas fa-address-card"></i> <?php echo $title; ?></h5>
	<div class="col-7 float-right">
	<div class="float-right">
	<a href="#" id="addpbkgroup" class="addpbkgroup nicebutton btn btn-sm btn-light">&#43; <?php echo lang('tni_group_add');?></a>
    <?php if($this->uri->segment(3)=='public') : ?>
	<a href="<?php echo site_url('phonebook/group/');?>" class="nicebutton btn btn-sm btn-light">&#43; <?php echo lang('kalkun_my_group');?></a>
    <?php else: ?>  
    <a href="<?php echo site_url('phonebook/group/public');?>" class="nicebutton btn btn-sm btn-light">&#43; <?php echo lang('kalkun_public_group');?></a>
    <?php endif; ?>		
	<a href="<?php echo site_url('phonebook');?>" class="nicebutton btn btn-sm btn-light">&#43; <?php echo lang('tni_groups_edit_contacts');?></a>
    </div>
	</div>
</div>
