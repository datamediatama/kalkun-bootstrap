...
<div class="card-header bg-secondary text-white">
	<h5 class="col-5 m-0 p-0 float-left"><i class="fas fa-address-book"></i> <?php echo $title; ?></h5>
	<div class="col-7 float-right">
	<div class="float-right">
	<a href="#" id="sendallcontact" class="nicebutton btn btn-sm btn-light">&#43; <?php echo lang('kalkun_send_to_all_contacts'); ?></a>
	<a href="#" id="addpbkcontact_wizard" class="nicebutton btn btn-sm btn-light">&#43; <?php echo lang('tni_contact_add'); ?></a>
     <?php if($public_contact) : ?>
	<a href="<?php echo site_url('phonebook/');?>" class="nicebutton btn btn-sm btn-light">&#43; <?php echo lang('kalkun_my_contact');?></a>
    <?php else: ?>  
    <a href="<?php echo site_url('phonebook/index/public');?>" class="nicebutton btn btn-sm btn-light">&#43; <?php echo lang('kalkun_public_contact');?></a>
    <?php endif; ?>	
	<a href="<?php echo site_url('phonebook/group');?>" id="addpbkgroup" class="nicebutton btn btn-sm btn-light">&#43; <?php echo lang('tni_groups_manage'); ?></a>
    </div>
	</div>
</div>
