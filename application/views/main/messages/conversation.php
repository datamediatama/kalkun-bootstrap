...
<div class="message_container <?php echo $tmp['source'];?>">
	<div class="message_header mt-3 mb-2" style="color: #444; height: 20px; overflow: hidden">
...
<tbody>
<tr class="message_container <?php echo $tmp['source'];?> message_toggle" style="cursor: pointer">
    <input  type="hidden" name="item_source<?php echo $tmp['ID'];?>"  id="item_source<?php echo $tmp['ID'];?>"  value="<?php echo $tmp['source']; ?>" />
    <input  type="hidden" class="item_number" name="item_number<?php echo $tmp['ID'];?>"  id="item_number<?php echo $tmp['ID'];?>"  value="<?php echo $number; ?>" />	
<td><input type="checkbox" id="<?php echo $tmp['ID'];?>" class="select_message nicecheckbox" value="<?php echo $tmp['ID'];?>" style="border: none;" /></td>
<td><span <?php  if($tmp['source'] == 'inbox' && $tmp['readed']=='false') echo "style=\"font-weight: bold\"";?>><?php echo nice_date($message_date);?>&nbsp;&nbsp;<img src="<?php echo $this->config->item('img_path').$arrow;?>.gif" />
	&nbsp;&nbsp;<?php echo $senderName;?></span></td>
<td><span <?php  if($tmp['source'] == 'inbox' && $tmp['readed']=='false') echo "style=\"font-weight: bold\"";?>><?php echo nice_date($message_date);?>&nbsp;&nbsp;<img src="<?php echo $this->config->item('img_path').$arrow;?>.gif" />
	&nbsp;&nbsp;<?php echo $senderName;?></span></td>
</tr>
</tbody>
...
?>	
	...
	<div class="optionmenu hidden col-12 small text-muted" style="padding-left: 20px">
	<ul class="nav justify-content-center bg-light">
	<li class="nav-item"><a class="detail_button" href="#"><div class="nav-link text-muted">Details</div></a></li>
					
	<?php if($tmp['source'] == 'inbox'): ?>
	<li class="nav-item"><a href="#" class="reply_button"><div class="nav-link text-muted"><?php echo lang('kalkun_reply');?></div></a></li>				
	<?php endif; ?>
		
	<?php if($type!='outbox'): ?>
	<li class="nav-item"><a href="#" class="forward_button"><div class="nav-link text-muted"><?php echo lang('kalkun_forward');?></div></a></li>
	<?php endif; ?>
	
	<?php if(!$on_pbk): ?>
	<li class="nav-item"><a href="#" class="add_to_pbk"><div class="nav-link text-muted"><?php echo lang('tni_contact_add'); ?></div></a></li>	
	<?php endif; ?>
	
	<?php if($tmp['source'] == 'sentitems'): ?>
	<li class="nav-item"><a href="#" class="resend"><div class="nav-link text-muted"><?php echo lang('kalkun_resend');?></div></a></li>		
	<?php endif; ?>
	</ul>
	</div>
