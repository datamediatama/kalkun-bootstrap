...
<?php                                        	
    ...
    <tr class="message_toggle" style="cursor: pointer;">
      <td><input type="checkbox" id="<?php echo $number;?>" class="select_conversation nicecheckbox" value="<?php echo $number;?>" style="border: none;" /></td>
      <td onclick="document.location.href='<?php echo site_url();?>/messages/conversation/<?php echo $folder;?>/<?php echo $type;?>/<?php echo $number;?>/<?php if($folder=='my_folder') echo $this->uri->segment(4);?>'"><?php echo nice_date($message_date);?>&nbsp;&nbsp;<img src="<?php echo $this->config->item('img_path').$arrow;?>.gif" /></td>
      <td onclick="document.location.href='<?php echo site_url();?>/messages/conversation/<?php echo $folder;?>/<?php echo $type;?>/<?php echo $number;?>/<?php if($folder=='my_folder') echo $this->uri->segment(4);?>'"><?php echo $senderName;?> <?php 
			if($folder=='folder'):
		...
		?></td>
      <td onclick="document.location.href='<?php echo site_url();?>/messages/conversation/<?php echo $folder;?>/<?php echo $type;?>/<?php echo $number;?>/<?php if($folder=='my_folder') echo $this->uri->segment(4);?>'"><?php echo message_preview($tmp->TextDecoded, $char_per_line);?></td>
    </tr>
