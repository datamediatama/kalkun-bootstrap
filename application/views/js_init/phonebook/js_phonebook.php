...
$(document).ready(function() {
	...
	else
	{
		...
		//$("#contact_container").dialog({modal: true}).dialog('open');
	}
	return false;
	});	
  ...
  if(grp_id == 'null' || grp_id == 'do') return false;
	...
	$('.sendmessage').bind('click', function() {
		...
		var param1 = $(this).parent().parent().parent().parent().children('.left_column').children('#pbkname').children('#pbknumber').text();
