...
$(document).ready(function() {
    ...
    $("input.select_conversation").on('click', null, function()
    {
    ...
    $("a.refresh_button, div#logo a").on('click', null, refresh = function(type)
    {  	
    	if(type != 'retry') {
	...
	$('#renamefolder').on('click', null, function() 
	{
	...
	$('#deletefolder').on('click', null, function()
	{
	...
	$('#delete-all-link').on('click', null, function()
	{
